...
namespace BlogApp.DataAccessLyaer.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Articles",
                columns: new[] { "ArticleId", "ArticleDescription", "ArticleTitle", "UserId" },
                values: new object[,]
                {
                    { 1, "This is the first article", "First Article", "1" },
                    { 2, "This is the second article", "Second Article", "1" }
                });

            migrationBuilder.InsertData(
                table: "Comments",
                columns: new[] { "CommentId", "ArticleId", "CommentText" },
                values: new object[,]
                {
                    { 1, 1, "This is a first comment" },
                    { 2, 2, "This is a second comment" }
                });
